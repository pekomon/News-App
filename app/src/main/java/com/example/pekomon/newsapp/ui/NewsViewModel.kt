...
import com.example.pekomon.newsapp.NewsApplication
    ...
    private suspend fun safeBreakingNewsCall(countryCode: String) {
        ...
        try {
            ...
            when (t) {
                ...
                else -> breakingNews.postValue(Resource.Error("Something went wrong. ${t.message}"))
            }
        }
    }
    ...
    private suspend fun safeSearchNewsCall(query: String) {
        ...
        try {
            ...
            when (t) {
                ...
                else -> searchNews.postValue(Resource.Error("Something went wrong. ${t.message}"))
            }
        }
    }
